...
import com.W9221214.AppLet.model.ClusterMarker;
import com.W9221214.AppLet.repository.Repository;
import com.W9221214.AppLet.utils.ClusterManagerRenderer;
...
import static com.W9221214.AppLet.utils.Constants.MapsCodes.ERROR_DIALOG_REQUEST;
import static com.W9221214.AppLet.utils.Constants.MapsCodes.MAPVIEW_BUNDLE_KEY;
import static com.W9221214.AppLet.utils.Constants.MapsCodes.PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION;
import static com.W9221214.AppLet.utils.Constants.MapsCodes.PERMISSIONS_REQUEST_ENABLE_GPS;
import static com.W9221214.AppLet.utils.Utils.getAddressClassFromString;
import static com.W9221214.AppLet.utils.Utils.isInternetAvailable;
...
public class Map extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private LiveData<List<AppLet>> allListings;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetAvailable(Map.this)) {
    ...
    private void initMap(Bundle savedInstanceState) {
        ...
        allListings.observe(this, new Observer<List<AppLet>>() {
            @Override
            public void onChanged(@Nullable List<AppLet> appLets) {
                ...
                if (appLets != null) {
                    for (AppLet appLet : appLets) {
                        photosUrls.add(appLet.getPhotos().get(0));
                    }
                }
        ...
        if (mGoogleMap != null) {
            ...
            if (allListings.getValue() != null) {
                for (int i = 0; i < allListings.getValue().size(); i++) {
                    try {
                        AppLet appLet = allListings.getValue().get(i);
                        Address address = getAddressClassFromString(appLet.getAddress(), getBaseContext());
                        Bitmap avatar = null;
                        try {
    ...
    public boolean isServicesOK() {
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance()
                    .getErrorDialog(Map.this, available,
